...
const Friends = () => {
  ...
  const revertUser = (index, name, category) => {
    const indexOfUser = users.findIndex((item) => item.name === name && item.category === category);

    const updatedUsers = [...users];

    updatedUsers[indexOfUser].category = category === friendCategory.acha ? friendCategory.bura: friendCategory.acha;
